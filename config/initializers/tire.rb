...
if Rails.env.production?
  ...
  PIC_DOMAIN = 'http://intimeoo.s3-website-ap-southeast-1.amazonaws.com/fileupload/img/' 
  AUDIO_DOMAIN = 'http://intimeoo.s3-website-ap-southeast-1.amazonaws.com/fileupload/audio/' 
